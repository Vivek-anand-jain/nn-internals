#!/usr/bin/env python3
"""
transformer_block.py — ground truth for page 07, "The Transformer Block".
...
The main trace (assets/data/trace.js) describes a 2 -> 3 -> 1 MLP. Page 07
needs a transformer, which the MLP trace does not contain, so this file
generates it. Nothing on page 07 may hand-type a number; everything it
...
def load_reference_configs(root):
    ...
    if not rc:
        raise SystemExit(
            ...
            "`python3 code/ground_truth.py` first -- page 07 takes its real "
...
# ============================================================================
# Page 07 opens by claiming the transformer introduces no new tensor CLASS.
