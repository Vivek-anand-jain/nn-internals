...
# page 19 covers that naming trap.)
...
def backward(P, cache, dOut):
    ...
    for L in range(N_LAYERS - 1, -1, -1):
        ...
        # attention input-gradient; page 10 caught that. All three are now
        ...
        for key, disp, group, tp_mode, why in specs:
            ...
            entries.append({
                ...
                "zero3": {"mode": "flat-sharded",
                          ...
                          # `flat_sharding` below is the real model. Page 22
...
def flat_sharding(entries, worlds=(2, 3, 4, 6, 8)):
    ...
    (Page 22 pointed out that at world 2 the single boundary happens to land
