...
Site page 08 (scaling) renders the same numbers. This file is the reference
...
# capacities that site page 08 offers in its dropdowns. Reading them from the
...
def print_presets(rc):
    ...
    print()
    print(f"  defaults on page 08: model {rc.get('default_model')!r}, "
...
def build_parser():
    p = argparse.ArgumentParser(
        ...
        epilog="Formulas are documented in this file's module docstring. "
               "Site page 08 must agree with them.")
